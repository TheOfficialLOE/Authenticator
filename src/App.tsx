...
const App = () => {
  return <div className="max-w-[75rem] mx-auto pt-40 flex flex-col md:flex-row justify-between flex-wrap">
    ...
    <div className="flex flex-col mt-6">
      ...
      <a href="https://github.com/TheOfficialLOE" target="_blank" className="flex items-center justify-center text-white my-6 p-4 h-16 w-80 font-bold border border-[#15151a] rounded-lg hover:border-[#353540] hover:text-[#0ce877] transition-all duration-100">
